...
# raw data provided by the WISA DB, Austria  
...
bio_wd <- "01_data/003_macrophytes/001_original_data/austria/raw/WISADatenabfrage_20211201_1359.xlsx"
...
saveRDS(data10, "data/macrophytes/original_data/austria/final_aggregated.rds")