...
bio      <- setDT(read_excel("01_data/003_macrophytes/001_original_data/spain_duero/raw_data/Datos_MACROF_DIATO_2016_20.xlsx"))
bio_id   <- setDT(read_excel("01_data/003_macrophytes/001_original_data/spain_duero/raw_data/TAXONES_ID_TAXON.xlsx"))
sites    <- setDT(read_excel("01_data/003_macrophytes/001_original_data/spain_duero/raw_data/INFO_PUNTOS_MUESTREO.xlsx"))
sampling <- setDT(read_excel("01_data/003_macrophytes/001_original_data/spain_duero/raw_data/METODO_MUESTREO.xlsx"))
...
saveRDS(data10, "01_data/003_macrophytes/001_original_data/spain_duero/final_aggregated.rds")
