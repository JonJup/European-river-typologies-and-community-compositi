...
# load data -------------------------------------------------------------------------
bio_wd  <- "01_data/002_fish/001_original_data/uk_ea_data_explorer/raw/FW_Fish_Counts_2021-11-12.csv"

bio     <- fread(bio_wd) 

harmonization_tables <- readRDS("01_data/002_fish/harmonization_table_fish.rds")
...
saveRDS(data10, "01_data/002_fish/001_original_data/uk_ea_data_explorer/final_aggregated.rds")
