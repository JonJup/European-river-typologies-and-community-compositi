...
# load data -------------------------------------------------------------------------
bio_wd  <- "01_data/002_fish/001_original_data/germany_mecklenburg/raw/Fische.xlsx"
...
saveRDS(data10, "01_data/002_fish/001_original_data/germany_mecklenburg/final_aggregated.rds")
