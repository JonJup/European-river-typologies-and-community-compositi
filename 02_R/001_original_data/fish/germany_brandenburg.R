...
# load data -------------------------------------------------------------------------
bio_wd  <- "01_data/002_fish/001_original_data/germany_brandenburg/raw/Biologische_Daten_Messstellen.xlsx"
...
fish_names <- read_excel("01_data/002_fish/001_original_data/Fischbezeichnungen.xlsx") |> setDT()
# prepare data ----------------------------------------------------------------------
...
saveRDS(data10, "01_data/002_fish/001_original_data/germany_brandenburg/final_aggregated.rds")
