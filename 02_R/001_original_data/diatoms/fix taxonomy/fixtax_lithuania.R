...
TU <- TU[which(!TU %in% taxontable_add$original_name)]
TU
taxontable[original_name == "Ulnaria ulna var. acus"]
taxontable_add[species == "Eunotia Complex", species := NA]
taxontable_add[species == "Ulnaria ulna var. acus", c("fixed_name", "species") := "Ulnaria ulna complex"]
taxontable <- rbindlist(list(taxontable, taxontable_add))

taxontable <- new_entry(ori = "Amphora ovalis v. ovalis", fix = "Amphora ovalis")
taxontable <- new_entry(ori = "Amphora ovalis v. pediculus", fix = "Amphora ovalis")
taxontable <- new_entry(ori = "Cymbella protracta", fix = "Cymbella protracta")
taxontable <- new_entry(ori = "Navicula sphaerophora"                 , fix = "Navicula sphaerophora")
taxontable <- new_entry(ori = "Navicula trinodis"                     , fix = "Achnanthidium trinode")
taxontable <- new_entry(ori = "Pinnularia microstauron f. biundulata" , fix = "Pinnularia microstauron")


taxontable <- new_genus(ori = "Gomphonema minutissimum", 
                        fix = "Exilaria minutissima", 
                        spe = "Exilaria minutissima", 
                        gen = "Exilaria", 
                        fam = "Bacillariophyta familia incertae sedis",
                        ord = "Bacillariophyta ordo incertae sedis",
                        cla = "Bacillariophyta classis incertae sedis")
