...
taxontable <- append_to_tt("Caloneis vasileyevae", "Caloneis vasilievskyana")
taxontable <- append_to_tt("Cymbella gracilis", "Cymbella neogracilis")
# - taxon not found. Going to genus level 
taxontable <- new_entry(ori = "Fragilaria cf.perpusilla", fix = "Fragilaria", spe = NA)
taxontable <- append_to_tt("Gomphonema calcifugum","Gomphonema calcifuga")    
taxontable <- append_to_tt("Humidophila contenta", "Humidicola contenta")
