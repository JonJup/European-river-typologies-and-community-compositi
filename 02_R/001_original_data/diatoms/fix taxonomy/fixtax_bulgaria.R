...
taxontable <- new_entry(ori = "Achnanthidium cf. nanum", fix = "Achnanthidium nanum")          
taxontable <- new_entry(ori = "Achnanthidium microscopicum s.l.", fix = "Psammothidium curtissimum")
taxontable <- new_entry(ori = "Cymatopleura apiculata", fix = "Cymatopleura apiculata")
taxontable <- new_entry(ori = "Cymbopleura subcistula", fix = "Cymbopleura subcistula")
taxontable <- new_entry(ori = "Fragilariforma mesolepta", fix = "Fragilariforma mesolepta")
taxontable <- new_entry(ori = "Gomphonema cymbellicum", fix = "Gomphonema parvulum Complex")
taxontable <- new_entry(ori = "Gomphonema cymbelliclinum Reichardt & Lange-Bertalot", fix = "Gomphonema parvulum Complex")
taxontable <- new_entry(ori = "Halamphora aff. tumida", fix = "Halamphora tumida")
taxontable <- new_entry(ori = "Mastogloia pusilla var. subcapitata", fix = "Mastogloia pusilla")
taxontable <- new_entry(ori = "Nitzschia fonticola f. minitissima", fix = "Nitzschia fonticola Complex")
taxontable <- new_entry(ori = "Sellaphora cf. elorantana", fix = "Sellaphora elorantana")
taxontable <- new_entry(ori = "Sellaphora madida", fix = "Sellaphora madida")

taxontable <- new_genus(ori = "Diatomella balfouriana", fix = "Diatomella balfouriana", spe = NA, 
                            gen = "Diatomella", fam = "Pinnulariaceae", ord = "Naviculales", cla = "Bacillariophyceae", phy = "Bacillariophyta", kin = "Chromista")
