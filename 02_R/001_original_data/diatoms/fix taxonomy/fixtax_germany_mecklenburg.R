...
taxontable <- new_entry(ori = "Krasskella kriegerana", fix = "Krasskella kriegerana")
taxontable <- new_entry(ori = "Surirella brightwellii var. baltica", fix = "Surirella", spe = NA, gen = "Surirella")
