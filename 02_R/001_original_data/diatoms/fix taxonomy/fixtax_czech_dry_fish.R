...
taxontable <- new_entry(ori = "Halamphora sp.", fix = "Halamphora", spe = NA)
taxontable <- new_entry(ori = "Achnanthidium neocryptocephalum", fix = "Achnanthidium neocryptocephalum")
